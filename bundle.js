...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Control__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Control */ \"./src/Control.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\nvar Counter = /** @class */ (function (_super) {\n    __extends(Counter, _super);\n    function Counter(parentNode, elName) {\n        var _this = _super.call(this, parentNode, \"div\", \"container-\" + elName + \" counter-container\") || this;\n        _this.value = new _Control__WEBPACK_IMPORTED_MODULE_0__[\"default\"](_this.node, \"h3\", \"value-\" + elName);\n        _this.title = new _Control__WEBPACK_IMPORTED_MODULE_0__[\"default\"](_this.node, \"h2\", \"title-\" + elName, \"\" + elName);\n        _this.expiredDate = new Date(\"May 20, 2022 00:00:00\").getTime();\n        return _this;\n    }\n    Counter.prototype.countdown = function () {\n        var _this = this;\n        setInterval(function () {\n            if (_this.title.node.innerHTML === \"days\")\n                _this.countdownValue = _this.getDays();\n            if (_this.title.node.innerHTML === \"hours\")\n                _this.countdownValue = _this.getHours();\n            if (_this.title.node.innerHTML === \"minutes\")\n                _this.countdownValue = _this.getMinutes();\n            if (_this.title.node.innerHTML === \"seconds\")\n                _this.countdownValue = _this.getSeconds();\n            _this.value.node.innerHTML = \"\" + _this.countdownValue;\n        });\n    };\n    Counter.prototype.setGap = function () {\n        var now = new Date().getTime();\n        return this.expiredDate - now;\n    };\n    Counter.prototype.getDays = function () {\n        return Math.floor(this.setGap() / this.setDays());\n    };\n    Counter.prototype.getHours = function () {\n        return Math.floor((this.setGap() % this.setDays()) / this.setHours());\n    };\n    Counter.prototype.getMinutes = function () {\n        return Math.floor((this.setGap() % this.setHours()) / this.setMinutes());\n    };\n    Counter.prototype.getSeconds = function () {\n        return Math.floor((this.setGap() % this.setMinutes()) / this.setSeconds());\n    };\n    Counter.prototype.setSeconds = function () {\n        this.seconds = 1000;\n        return this.seconds;\n    };\n    Counter.prototype.setMinutes = function () {\n        this.minutes = this.setSeconds() * 60;\n        return this.minutes;\n    };\n    Counter.prototype.setHours = function () {\n        this.hours = this.setMinutes() * 60;\n        return this.hours;\n    };\n    Counter.prototype.setDays = function () {\n        this.days = this.setHours() * 24;\n        return this.days;\n    };\n    return Counter;\n}(_Control__WEBPACK_IMPORTED_MODULE_0__[\"default\"]));\n/* harmony default export */ __webpack_exports__[\"default\"] = (Counter);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/Countdown/Counter.ts\n");
